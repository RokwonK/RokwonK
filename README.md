...
### Work Experience  
- 20.11 ~ 22.05 📱 스크린 골프/레슨 예약 플랫폼 '김캐디' **iOS 개발/유지보수**  
👉 *60만 유저, 스토어후기 60개 -> 1600개, 평점 4.9, MAU 10만이상, 앱스토어 스포츠 분야 3위*  

### Experience
- 22.10 ~ 진행중  💻 문제풀이 기반 학습/공유/피드백 서비스 'The Pool' **인프라/백엔드 개발**  
- 22.05 ~ 22.12 📱 CS 1일 1질문/면접 커뮤니티 '개발 한 스푼' **iOS/Android 개발(Flutter)**  
👉 *5000 다운로드 이상, DAU - max 340, avg 150*  
- 22.03 ~ 22.06 📱 위치 기반 익명 그룹채팅 '티키타카' **iOS 개발**  
👉 *디프만 최우수상, Behance 큐레이터 추천 프로젝트 선정*  
- 19.10 ~ 20.01 📱 대학 자취방 중개 플랫폼 '본방사수' **iOS/Android 개발(React Native)**  
👉 *재학생 중 약 8% 사용, 실계약 다수 존재*  
